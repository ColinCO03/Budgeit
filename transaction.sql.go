...
INSERT INTO transactions (
  ...
  $1, $2
) RETURNING id, name, type, account_id, amount, created_at
`
...
SELECT id, name, type, account_id, amount, created_at FROM transactions
WHERE id = $1 LIMIT 1
`
...
func (q *Queries) ListTransaction(ctx context.Context, arg ListTransactionParams) ([]Transaction, error) {
	rows, err := q.db.QueryContext(ctx, listTransaction, arg.AccountID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
